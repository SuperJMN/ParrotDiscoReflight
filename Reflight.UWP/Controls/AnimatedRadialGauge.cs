...
namespace ParrotDiscoReflight.Controls
{
    ...
    public class AnimatedRadialGauge : Control
    {
        /// <summary>
        /// Identifies the Minimum dependency property.
        /// </summary>
        public static readonly DependencyProperty MinimumProperty =
            DependencyProperty.Register(nameof(Minimum), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(0.0, OnScaleChanged));

        /// <summary>
        /// Identifies the Maximum dependency property.
        /// </summary>
        public static readonly DependencyProperty MaximumProperty =
            DependencyProperty.Register(nameof(Maximum), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(100.0, OnScaleChanged));

        /// <summary>
        /// Identifies the optional StepSize property.
        /// </summary>
        public static readonly DependencyProperty StepSizeProperty =
            DependencyProperty.Register(nameof(StepSize), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(0.0));

        /// <summary>
        /// Identifies the <see cref="IsInteractive"/> property.
        /// </summary>
        public static readonly DependencyProperty IsInteractiveProperty =
            DependencyProperty.Register(nameof(IsInteractive), typeof(bool), typeof(AnimatedRadialGauge), new PropertyMetadata(false, OnInteractivityChanged));

        /// <summary>
        /// Identifies the ScaleWidth dependency property.
        /// </summary>
        public static readonly DependencyProperty ScaleWidthProperty =
            DependencyProperty.Register(nameof(ScaleWidth), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(26.0, OnScaleChanged));

        /// <summary>
        /// Identifies the NeedleBrush dependency property.
        /// </summary>
        public static readonly DependencyProperty NeedleBrushProperty =
            DependencyProperty.Register(nameof(NeedleBrush), typeof(SolidColorBrush), typeof(AnimatedRadialGauge), new PropertyMetadata(null, OnFaceChanged));

        /// <summary>
        /// Identifies the Value dependency property.
        /// </summary>
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register(nameof(Value), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(0.0, OnValueChanged));

        /// <summary>
        /// Identifies the Unit dependency property.
        /// </summary>
        public static readonly DependencyProperty UnitProperty =
            DependencyProperty.Register(nameof(Unit), typeof(string), typeof(AnimatedRadialGauge), new PropertyMetadata(string.Empty));

        /// <summary>
        /// Identifies the TrailBrush dependency property.
        /// </summary>
        public static readonly DependencyProperty TrailBrushProperty =
            DependencyProperty.Register(nameof(TrailBrush), typeof(Brush), typeof(AnimatedRadialGauge), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the ScaleBrush dependency property.
        /// </summary>
        public static readonly DependencyProperty ScaleBrushProperty =
            DependencyProperty.Register(nameof(ScaleBrush), typeof(Brush), typeof(AnimatedRadialGauge), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the ScaleTickBrush dependency property.
        /// </summary>
        public static readonly DependencyProperty ScaleTickBrushProperty =
            DependencyProperty.Register(nameof(ScaleTickBrush), typeof(Brush), typeof(AnimatedRadialGauge), new PropertyMetadata(null, OnFaceChanged));

        /// <summary>
        /// Identifies the TickBrush dependency property.
        /// </summary>
        public static readonly DependencyProperty TickBrushProperty =
            DependencyProperty.Register(nameof(TickBrush), typeof(SolidColorBrush), typeof(AnimatedRadialGauge), new PropertyMetadata(null, OnFaceChanged));

        /// <summary>
        /// Identifies the ValueStringFormat dependency property.
        /// </summary>
        public static readonly DependencyProperty ValueStringFormatProperty =
            DependencyProperty.Register(nameof(ValueStringFormat), typeof(string), typeof(AnimatedRadialGauge), new PropertyMetadata("N0"));

        /// <summary>
        /// Identifies the TickSpacing dependency property.
        /// </summary>
        public static readonly DependencyProperty TickSpacingProperty =
        DependencyProperty.Register(nameof(TickSpacing), typeof(int), typeof(AnimatedRadialGauge), new PropertyMetadata(10, OnFaceChanged));

        /// <summary>
        /// Identifies the NeedleLength dependency property.
        /// </summary>
        public static readonly DependencyProperty NeedleLengthProperty =
            DependencyProperty.Register(nameof(NeedleLength), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(100d, OnFaceChanged));

        /// <summary>
        /// Identifies the NeedleWidth dependency property.
        /// </summary>
        public static readonly DependencyProperty NeedleWidthProperty =
            DependencyProperty.Register(nameof(NeedleWidth), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(5d, OnFaceChanged));

        /// <summary>
        /// Identifies the ScalePadding dependency property.
        /// </summary>
        public static readonly DependencyProperty ScalePaddingProperty =
            DependencyProperty.Register(nameof(ScalePadding), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(23d, OnFaceChanged));

        /// <summary>
        /// Identifies the ScaleTickWidth dependency property.
        /// </summary>
        public static readonly DependencyProperty ScaleTickWidthProperty =
            DependencyProperty.Register(nameof(ScaleTickWidth), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(2.5, OnFaceChanged));

        /// <summary>
        /// Identifies the TickWidth dependency property.
        /// </summary>
        public static readonly DependencyProperty TickWidthProperty =
            DependencyProperty.Register(nameof(TickWidth), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(5d, OnFaceChanged));

        /// <summary>
        /// Identifies the TickLength dependency property.
        /// </summary>
        public static readonly DependencyProperty TickLengthProperty =
            DependencyProperty.Register(nameof(TickLength), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(18d, OnFaceChanged));

        /// <summary>
        /// Identifies the MinAngle dependency property.
        /// </summary>
        public static readonly DependencyProperty MinAngleProperty =
            DependencyProperty.Register(nameof(MinAngle), typeof(int), typeof(AnimatedRadialGauge), new PropertyMetadata(-150, OnScaleChanged));

        /// <summary>
        /// Identifies the MaxAngle dependency property.
        /// </summary>
        public static readonly DependencyProperty MaxAngleProperty =
            DependencyProperty.Register(nameof(MaxAngle), typeof(int), typeof(AnimatedRadialGauge), new PropertyMetadata(150, OnScaleChanged));

        /// <summary>
        /// Identifies the ValueAngle dependency property.
        /// </summary>
        protected static readonly DependencyProperty ValueAngleProperty =
            DependencyProperty.Register(nameof(ValueAngle), typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(null));
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimatedRadialGauge"/> class.
        /// Create a default radial gauge control.
        /// </summary>
        public AnimatedRadialGauge()
        {
            DefaultStyleKey = typeof(AnimatedRadialGauge);
        ...
        {
            AnimatedRadialGauge radialGauge = (AnimatedRadialGauge)d;
                ...
                if (trail != null)
                {
                    if (radialGauge.ValueAngle > radialGauge.NormalizedMinAngle)
                    {
                        ...
                        if (radialGauge.ValueAngle - radialGauge.NormalizedMinAngle == 360)
                        {
                            ...
                            eg.Center = new Windows.Foundation.Point(100, 100);
        ...
        private static void OnFaceChanged(DependencyObject d)
        {
            ...
            radialGauge._needle.Size = new Vector2((float)radialGauge.NeedleWidth, (float)(radialGauge.NeedleLength - radialGauge.NeedlePadding));
        ...
        public static readonly DependencyProperty NeedlePaddingProperty = DependencyProperty.Register(
            "NeedlePadding", typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(default(double)));

        public double NeedlePadding
        {
            get { return (double) GetValue(NeedlePaddingProperty); }
            set { SetValue(NeedlePaddingProperty, value); }
        }
        ...
        private void SetGaugeValueFromPoint(Windows.Foundation.Point p)
        {
            var pt = new Windows.Foundation.Point(p.X - (ActualWidth / 2), -p.Y + (ActualHeight / 2));
        ...
        private Windows.Foundation.Point ScalePoint(double angle, double middleOfScale)
        {
            return new Windows.Foundation.Point(100 + (Math.Sin(Degrees2Radians * angle) * middleOfScale), 100 - (Math.Cos(Degrees2Radians * angle) * middleOfScale));
        }
        ...
        public static readonly DependencyProperty AnimatableValueProperty = DependencyProperty.Register(
            "AnimatableValue", typeof(double), typeof(AnimatedRadialGauge), new PropertyMetadata(default(double), OnAnimatableValueChanged));

        private static void OnAnimatableValueChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            Storyboard.SetTarget(st, d);
            Storyboard.SetTargetProperty(st, "Value");

            st.Begin();
        }

        public double AnimatableValue
        {
            get { return (double)GetValue(AnimatableValueProperty); }
            set { SetValue(AnimatableValueProperty, value); }
        }

        public static readonly DependencyProperty ContentProperty = DependencyProperty.Register(
            "Content", typeof(object), typeof(AnimatedRadialGauge), new PropertyMetadata(default(object)));
