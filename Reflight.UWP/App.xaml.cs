...
namespace ParrotDiscoReflight
{
    sealed class CompositionRoot
    {
        public static object GetMainContext(Frame rootFrame)
        {
            ...
            var flightAcademyPickViewModel = new GalleryPickViewModel(FactoryClient, settingsService, dialogService);

            var manualPickViewModel = new ManualPickViewModel(fileOpenCommands, FactoryClient, dialogService);
